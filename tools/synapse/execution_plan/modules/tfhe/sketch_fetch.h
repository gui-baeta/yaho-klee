...
class SketchFetch : public tfheModule {
private:
  addr_t sketch_addr;
  BDD::symbol_t overflow;

public:
  SketchFetch() : tfheModule(ModuleType::tfhe_SketchFetch, "SketchFetch") {}

  SketchFetch(BDD::Node_ptr node, addr_t _sketch_addr,
              BDD::symbol_t _overflow)
      : tfheModule(ModuleType::tfhe_SketchFetch, "SketchFetch", node),
