...
class ExpireItemsSingleMap : public tfheModule {
private:
  addr_t dchain_addr;
  addr_t vector_addr;
  addr_t map_addr;
...
public:
  ExpireItemsSingleMap()
      : tfheModule(ModuleType::tfhe_ExpireItemsSingleMap,
                  "ExpireItemsSingleMap") {}
  ...
  ExpireItemsSingleMap(BDD::Node_ptr node, addr_t _dchain_addr,
      ...
      : tfheModule(ModuleType::tfhe_ExpireItemsSingleMap, "ExpireItemsSingleMap",
                  node),
