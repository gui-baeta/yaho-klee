...
class SketchRefresh : public tfheModule {
private:
  addr_t sketch_addr;
  klee::ref<klee::Expr> time;

public:
  SketchRefresh() : tfheModule(ModuleType::tfhe_SketchRefresh, "SketchRefresh") {}

  SketchRefresh(BDD::Node_ptr node, addr_t _sketch_addr,
                klee::ref<klee::Expr> _time)
      : tfheModule(ModuleType::tfhe_SketchRefresh, "SketchRefresh", node),
