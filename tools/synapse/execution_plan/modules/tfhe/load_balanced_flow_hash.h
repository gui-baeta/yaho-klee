...
class LoadBalancedFlowHash : public tfheModule {
private:
...
public:
  LoadBalancedFlowHash()
      : tfheModule(ModuleType::tfhe_LoadBalancedFlowHash,
                  "LoadBalancedFlowHash") {}

  LoadBalancedFlowHash(BDD::Node_ptr node, klee::ref<klee::Expr> _obj,
                       BDD::symbol_t _hash)
      : tfheModule(ModuleType::tfhe_LoadBalancedFlowHash, "LoadBalancedFlowHash",
                  node),
        obj(_obj), hash(_hash) {}
