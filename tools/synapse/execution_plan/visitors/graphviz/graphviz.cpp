...
DEFAULT_VISIT_PRINT_MODULE_NAME(targets::tfhe::NoOpPacketReturnChunk)
DEFAULT_VISIT_PRINT_MODULE_NAME(targets::tfhe::TruthTablePBS)
DEFAULT_VISIT_PRINT_MODULE_NAME(targets::tfhe::Conditional)
DEFAULT_VISIT_PRINT_MODULE_NAME(targets::tfhe::UnivariatePBS)
DEFAULT_VISIT_PRINT_MODULE_NAME(targets::tfhe::BivariatePBS)
DEFAULT_VISIT_PRINT_MODULE_NAME(targets::tfhe::Change)
DEFAULT_VISIT_PRINT_MODULE_NAME(targets::tfhe::NoChange)
DEFAULT_VISIT_PRINT_MODULE_NAME(targets::tfhe::AidedUnivariatePBS)
